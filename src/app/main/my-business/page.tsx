      ...
      >
        <motion.div className="max-w-7xl w-full flex flex-col items-center justify-center mt-5 pb-20">
          ...
          <div className="w-full mx-auto px-4 items-center justify-center flex flex-col mb-5">
            <button onClick={()=> router.push("/add-product")} className="p-2 bg-gradient-to-r from-stone-800 via-stone-300 to-stone-800 rounded-full hover:opacity-70 active:opacity-40 cursor-pointer w-80 shadow-lg shadow-black">Add Product</button>
          </div>
          {isFetchingProducts ? (
