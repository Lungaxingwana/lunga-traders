    ...
    <div className="w-full mx-auto justify-center  align-middle flex flex-1 bg-stone-200 min-h-screen mt-10 pt-10">
      <div className="justify-center items-center align-middle w-96 h-[770] bg-white border border-stone-500 rounded-xl shadow-stone-500 shadow-lg space-y-2">
        <div className="bg-stone-500 mx-10 rounded-b-full">
          <p className="w-full text-center">Create Account Screen</p>
        </div>
        <div className="w-full px-4">
          <button
            onClick={showCroppedImage}
            className="w-full h-[400] justify-center align-middle items-center mt-5 rounded-t-xl border border-stone-500"
          >
              ...
              >
                {isLoading ? (
                  <div className="flex gap-3">
                    ...
                    <p className="text-white">Creating acc...</p>
                  </div>
                ) : (
                  <div className="flex gap-x-2 items-center justify-center align-middle">
                    <MdCreateNewFolder size={24} color="white"/>
