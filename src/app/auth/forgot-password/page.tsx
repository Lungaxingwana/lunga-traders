    ...
    return (
        <div className="w-full mx-auto justify-center align-middle flex flex-1 mt-10 pt-10 bg-stone-200 min-h-screen">
            <div className="justify-center items-center align-middle w-96 h-[620] bg-white border border-stone-500 rounded-xl shadow-stone-500 shadow-lg space-y-2">
                <div className="bg-stone-500 mx-10 rounded-b-full"><p className="w-full text-center">Forgot Password Screen</p></div>
                ...
                <p className="px-16 text-stone-500 text-center">Please enter your <span className="font-bold">email address</span> to get your lost password</p>
                ...
                <div className='w-full justify-evenly items-center align-middle flex'>
                    <div className='flex justify-evenly w-full items-center align-middle'>
                        ...
                        <div className='w-7/12 mx-auto justify-center flex mt-6 p-2'>
                            ...
                            <button onClick={handleLogin} className='p-2 hover:bg-stone-400 font-bold bg-stone-500 shadow-xl shadow-black active:opacity-40 w-full justify-center items-center align-middle rounded-full'>
                                {isLoading ? <div className='flex gap-3'><ImSpinner9 size={23} className="animate-spin" /><p>Loading...</p></div> : <div className="flex gap-x-2 items-center align-middle justify-center"><FcDataRecovery size={24}/><p>Recover Password</p></div>}
                            </button>
