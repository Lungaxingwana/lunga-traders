...
import { FaUser, FaTransgender, FaAddressCard, FaPhone, FaMars, FaVenus, FaGenderless, FaUserShield, FaUserAlt } from "react-icons/fa";
import { HiEye, HiEyeOff } from "react-icons/hi";
import { FiUserPlus, FiLogIn } from "react-icons/fi";
import Cropper from "react-easy-crop";
import Slider from "@mui/material/Slider";
import { useAuthStore } from "@/stores/useAuthStore";
import { useRouter } from "react-router-dom"; // Use react-router-dom for navigation
...
export default function SignupScreen() {
  ...
  const router = useRouter(); // from react-router-dom
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await signup({form: formData, navigate: (path) => router.push(path)});
        ...
        <form className="space-y-5 w-full" onSubmit={handleSubmit} noValidate>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="relative flex flex-col">
              <span className="absolute left-3 top-3 text-gray-400"><FaTransgender size={18} /></span>
              <div className="flex gap-2 pl-10 py-2">
